...
/*std::string*/ void DES::Triple_DES_Encrypt(std::string plaintext){	
	// PC1 table
	...
	std::cout << std::endl <<"Clear text -> " << plaintext << std::endl;
    ...
    std::cout << std::endl <<"Stage 1 -> " << cipher << std::endl << std::endl;
    ...
    std::cout <<"Stage 2 -> " << cipher_2 << std::endl << std::endl;
    ...
    std::cout <<"Stage 3 -> " << cipher_final << std::endl << std::endl;
    //return cipher;
}
DES::~DES(void){}
